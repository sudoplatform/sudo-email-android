...
/**
 * Test the correct operation of [SudoEmailClient.getEmailMaskDomains]
 * using mocks and spies.
 */
@RunWith(RobolectricTestRunner::class)
class SudoEmailGetEmailMaskDomainsTest : BaseTests() {
    ...
    @Test
    fun `getEmailMaskDomains() should return results when no error present`() =
        runTest {
            val deferredResult =
                async(StandardTestDispatcher(testScheduler)) {
                    client.getEmailMaskDomains()
                }
    ...
    @Test
    fun `getEmailMaskDomains() should return empty list output when query result data is empty`() =
        runTest {
    ...
    @Test
    fun `getEmailMaskDomains() should throw when response has error`() =
        runTest {
            val testError =
