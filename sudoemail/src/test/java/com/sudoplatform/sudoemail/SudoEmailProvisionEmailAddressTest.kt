...
class SudoEmailProvisionEmailAddressTest : BaseTests() {
    ...
    @Test
    fun `provisionEmailAddress() should throw when email mutation response is null`() =
        runTest {
            mockApiClient.stub {
                onBlocking {
                    provisionEmailAddressMutation(
    ...
    @Test
    fun `provisionEmailAddress() should throw if key manager returns null key pair`() =
        runTest {
    ...
    @Test
    fun `provisionEmailAddress() should throw when key registration fails`() =
        runTest {
            mockServiceKeyManager.stub {
    ...
    @Test
    fun `provisionEmailAddress() should generate symmetric key if one doesn't exist`() =
        runTest {
            mockServiceKeyManager.stub {
