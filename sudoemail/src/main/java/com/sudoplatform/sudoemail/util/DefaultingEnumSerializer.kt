...
internal abstract class DefaultingEnumSerializer<T : Enum<T>>(
    values: EnumEntries<out T>,
    ...
    override fun deserialize(decoder: Decoder): T = deserialized.getOrDefault(decoder.decodeString(), defaultValue)
}
