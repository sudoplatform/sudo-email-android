...
/**
 * Core entity representation of a draft email message with content in the Sudo Platform Email SDK.
 *
 ...
 */
@Parcelize
internal data class DraftEmailMessageWithContentEntity(
    val id: String,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as DraftEmailMessageWithContentEntity
