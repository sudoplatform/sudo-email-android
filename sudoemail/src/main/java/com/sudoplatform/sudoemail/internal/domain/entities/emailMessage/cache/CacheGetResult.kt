 ...
 * @property sealedBlob [ByteArray] The sealed message blob as retrieved from S3, before unsealing.
 * @property contentEncoding [String] The S3 content-encoding header value, used to determine the decoding pipeline.
 */
internal data class CacheGetResult(
