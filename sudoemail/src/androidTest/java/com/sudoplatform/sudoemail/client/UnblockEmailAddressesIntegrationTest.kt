...
class UnblockEmailAddressesIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun unblockEmailAddressesShouldThrowAnErrorIfPassedDuplicateAddresses() =
        runTest {
    ...
    @Test
    fun unblockingAnAddressThatIsNotBlockedShouldReturnSuccess() =
        runTest {
            val sudo = sudoClient.createSudo(TestData.sudo)
            sudo shouldNotBe null
            sudoList.add(sudo)
    ...
    @Test
    fun unblockingMultipleBlockedAddressesShouldReturnSuccess() =
        runTest {
            val sudo = sudoClient.createSudo(TestData.sudo)
            sudo shouldNotBe null
            sudoList.add(sudo)
