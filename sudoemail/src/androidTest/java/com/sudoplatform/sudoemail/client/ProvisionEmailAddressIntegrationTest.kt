...
class ProvisionEmailAddressIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun provisionEmailAddressShouldReturnEmailAddress() =
        runTest {
    ...
    @Test
    fun provisionEmailAddressShouldAllowMultipleEmailsPerSudo() =
        runTest {
            val sudo = createSudo(TestData.sudo)
            sudo.id shouldNotBe null
            sudoList.add(sudo)
    ...
    @Test
    fun provisionEmailAddressWithAliasShouldReturnEmailAddress() =
        runTest {
            val sudo = createSudo(TestData.sudo)
            sudo.id shouldNotBe null
            sudoList.add(sudo)
    ...
    @Test
    fun provisionEmailAddressShouldThrowWithUnsupportedDomain() =
        runTest {
    ...
    @Test
    fun provisionEmailAddressShouldFailWithInvalidLocalPart() =
        runTest {
            val sudo = sudoClient.createSudo(TestData.sudo)
            sudo shouldNotBe null
            sudoList.add(sudo)
    ...
    @Test
    fun provisionEmailAddressShouldThrowWithExistingAddressExceptionAfterDeprovisioning() =
        runTest {
            val sudo = sudoClient.createSudo(TestData.sudo)
            sudo shouldNotBe null
            sudoList.add(sudo)
