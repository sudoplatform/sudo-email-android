...
class DeleteMessageForFolderIdIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun deleteMessagesForFolderIdShouldFailIfGivenInvalidEmailAddressId() = runTest {
    ...
    @Test
    fun deleteMessagesForFolderIdShouldFailIfGivenInvalidEmailFolderId() = runTest {
        val sudo = createSudo(TestData.sudo)
        sudo shouldNotBe null
        sudoList.add(sudo)
        val ownershipProof = getOwnershipProof(sudo)
    ...
    @Test
    fun deleteMessagesForFolderIdShouldDeleteASingleMessage() = runTest {
        val sudo = createSudo(TestData.sudo)
        sudo shouldNotBe null
        sudoList.add(sudo)
        val ownershipProof = getOwnershipProof(sudo)
        ...
        val inboxFolder = getFolderByName(
            client = emailClient,
            emailAddressId = emailAddress.id,
            folderName = "INBOX",
        ...
        val result = emailClient.deleteMessagesForFolderId(
    ...
    @Test
    fun deleteMessagesForFolderIdShouldDeleteMultipleMessages() = runTest(timeout = Duration.parse("2m")) {
        val sudo = createSudo(TestData.sudo)
        sudo shouldNotBe null
        sudoList.add(sudo)
        val ownershipProof = getOwnershipProof(sudo)
        ...
        val sentFolder = getFolderByName(
            client = emailClient,
            emailAddressId = emailAddress.id,
            folderName = "SENT",
        ) ?: fail("EmailFolder could not be found")
    ...
    @Test
    fun deleteMessagesForFolderIdMovesMessagesToTrashWithHardDeleteFalse() = runTest {
        val sudo = createSudo(TestData.sudo)
        sudo shouldNotBe null
        sudoList.add(sudo)
        val ownershipProof = getOwnershipProof(sudo)
        ...
        val trashFolder = getFolderByName(
            client = emailClient,
            emailAddressId = emailAddress.id,
            folderName = "TRASH",
        ) ?: fail("EmailFolder could not be found")
    ...
    @Test
    fun deleteMessagesForFolderIdAlwaysHardDeletesFromTrash() = runTest {
        val sudo = createSudo(TestData.sudo)
        sudo shouldNotBe null
        sudoList.add(sudo)
        val ownershipProof = getOwnershipProof(sudo)
    ...
    @Test
    fun deleteMessagesForFolderIdWorksWithCustomFolders() = runTest {
        val sudo = createSudo(TestData.sudo)
        sudo shouldNotBe null
        sudoList.add(sudo)
        val ownershipProof = getOwnershipProof(sudo)
        ...
        val customFolder = emailClient.createCustomEmailFolder(
