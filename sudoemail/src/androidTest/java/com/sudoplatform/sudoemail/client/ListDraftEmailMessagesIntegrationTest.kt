...
class ListDraftEmailMessagesIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun listDraftEmailMessagesShouldReturnEmptyListWhenDraftMessagesNotFound() =
        runTest {
    ...
    @Test
    fun listDraftEmailMessagesShouldReturnListOfDraftMessages() =
        runTest {
            val sudo = createSudo(TestData.sudo)
            sudo shouldNotBe null
            sudoList.add(sudo)
    ...
    @Test
    fun listDraftEmailMessagesShouldMigrateMessagesFromTransientBucket() =
        runTest {
            val sudo = createSudo(TestData.sudo)
            sudo shouldNotBe null
            sudoList.add(sudo)
    ...
    @Test
    fun listDraftEmailMessagesShouldMigrateMessagesWithLegacyKeyIdMetadataKey() =
        runTest {
            val sudo = createSudo(TestData.sudo)
            sudo shouldNotBe null
            sudoList.add(sudo)
